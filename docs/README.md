...
[Edit](https://github.com/theodorosploumis/portfolio/edit/master/docs/index.md)
...
- [soda - Small Open Data Framework](https://www.drupal.org/project/soda)
- [Hidden Catalog](https://github.com/theodorosploumis/hidden-catalog)
- [Affilio](https://github.com/theodorosploumis/affilio/tree/7.x-1.x)
- [ManyStories](https://github.com/manystories/manystories)

## Drupal modules
- [Sage DataStream XML API integration](https://www.drupal.org/project/sage)
- [Scrollbar](https://www.drupal.org/project/scrollbar)
- [Human Decimal Formatter](https://www.drupal.org/project/human_decimal)
- [Linkwise Advertiser](https://github.com/theodorosploumis/linkwise)
...
- [Drush plugins in Docker](https://github.com/theodorosploumis/drush-plugins)
...
## Logos and Identity
- [See on Pinterest](https://gr.pinterest.com/theoploumis/logosidentity)

## Collections and Manuals
- [HackTools](https://hack-tools.github.io)
- [DrupalTools](https://drupaltools.github.io)
- [Docs - Building a collaborative Drupal 8.x distribution](http://dropdog.readthedocs.io)
...
- [Using Docker with Drupal - Introduction](https://theodorosploumis.github.io/drupalcamp2016)
- [Docker with Java - Introduction](https://theodorosploumis.github.io/docker-java)
- [Docker with NodeJS - Introduction](http://theodorosploumis.github.io/docker-nodejs)
- [Linked Data, RDF, SPARQL and the future](http://theodorosploumis.github.io/linked-data)
- [Open data and open source licenses](http://theodorosploumis.github.io/open-licenses)

### 2015
- [Ansible - The configuration management tool for humans](https://theodorosploumis.github.io/ansible-python)
...
- [Plain Lists](https://github.com/theodorosploumis/plain_lists)
